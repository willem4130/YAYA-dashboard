...
export const YAYA_WORKFLOWS: Record<string, YayaWorkflowConfig> = {
  'yaya-creative-assistant': {
    ...
    // n8n Integration for chat workflow
    n8nWorkflowId: 'GsZCj8cA0WX6sgWm', // Your actual n8n workflow ID
    webhookId:
      'https://primary-production-c041f.up.railway.app/webhook/ee7ff2e9-9c2f-4c31-81af-76cbb3f74a9e', // Railway webhook URL

    inputSchema: {
      required: ['message'],
      optional: ['context', 'conversationId'],
      fields: {
        message: {
          type: 'string',
          description: 'User message or question for the creative assistant',
        },
        context: {
          type: 'string',
    ...
    outputs: {
      types: ['text'],
      description:
        'Intelligent responses with YAYA brand voice and creative guidance',
    },
    ...
    defaultConfig: {
      ...
      description: 'Railway production n8n instance - stable and reliable',
    },
  },
  'spring-collection-storytelling': {
    ...
    inputSchema: {
      ...
      fields: {
        collectionTheme: {
          type: 'string',
          description:
            'Main theme for the collection (e.g., "Urban Comfort", "Natural Elegance")',
          enum: [
            'Urban Comfort',
            'Natural Elegance',
    ...
    outputs: {
      types: ['text', 'image'],
      description:
        'Brand narratives, social media captions, and visual content concepts',
    },
  ...
  'sustainable-materials-tracker': {
    ...
    outputs: {
      types: ['file', 'text'],
      description:
        'Sustainability reports, compliance documentation, and improvement recommendations',
    },
  ...
  'client-style-profiles': {
    ...
    outputs: {
      types: ['file', 'text'],
      description:
        'Customer insights reports, styling recommendations, and trend analysis',
    },
  ...
  'boutique-visual-merchandising': {
    ...
    outputs: {
      ...
      description:
        'Visual merchandising concepts, setup instructions, and styling guides',
    },
  ...
  'seasonal-campaign-coordinator': {
    ...
    outputs: {
      ...
      description:
        'Campaign strategies, content calendars, and creative briefs',
    },
...
function validateFieldType(
  value: any,
  schema: YayaWorkflowConfig['inputSchema']['fields'][string]
): {
  isValid: boolean
  error?: string
  value: any
...
export function getWorkflowByCategory(category: string): YayaWorkflowConfig[] {
  return Object.values(YAYA_WORKFLOWS).filter(
